...
const HomeCoverSection = () => {
    ...
    return (
        <div className='w-full inline-block '>
            ...
            <Link href= '/blogs' className="inline-block py-2 sm:py-3 px-6 sm:px-10   text-light rounded-full capitalize font-semibold border-2 border-solid border-light hover:scale-105 transition-all ease duration-200 text-sm sm:text-base">
    Lorem 
    </Link>
