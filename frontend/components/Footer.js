...
const Footer = () => {
  ...
  return (
    <footer className="mt-16 rounded-2xl bg-[#1b1b1b]  m-2 sm:m-10 flex flex-col items-center text-light ">
      ...
      <form
        ...
        className="mt-6 w-fit  flex items-stretch bg-light  p-1 sm:p-2 rounded mx-4"
      >
        <input
          type="email"
      ...
      <div className="flex items-center mt-8">
        ...
        <a
          ...
          rel="noopener noreferrer"
        >
          <FacebookIcon className="fill-light  hover:scale-125 transition-all ease duration-200" />
        </a>
        <a
